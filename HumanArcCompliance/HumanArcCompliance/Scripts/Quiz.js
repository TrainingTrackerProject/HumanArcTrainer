...
//Stores the questions and answers into QuestionAnswer
Myapp.controller('QuizCtrl', function ($scope, getQuestion) {
...
Myapp.directive("questionContainer", function () {
    return {
        ...
        + ' <input type="button" ng-click="nextQuestion()" value="Next"/>' + '</div><br>',
        restrict: "E"
    };
});
